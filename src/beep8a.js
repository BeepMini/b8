...
/// return:
///   An Image object that you can use with beep8.drawImage().
...
/// return:
///   A Sound object that you can use with beep8.playSound().
...
///   beep8.setFont() and beep8.drawText().
